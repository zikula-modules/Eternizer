...
namespace MU\EternizerModule\NewsletterPlugin;
...
class ItemListPlugin extends Newsletter_AbstractPlugin
{
    ...
    {
        return $this->__('List of entries');
    }
    ...
    {
        return $this->__('This plugin shows a list of entries of the MUEternizerModule module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['entry'] = array('name' => $this->__('Entries'));
        }
    ...
    protected function selectPluginData($args, $filtAfterDate = null)
    {
        ...
        foreach ($entities as $k => $item) {
            ...
            $url = $serviceManager->get('router')->generate('mueternizermodule_' . strtolower($objectType) . '_display', $urlArgs, true);
