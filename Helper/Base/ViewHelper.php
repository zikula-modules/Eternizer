...
class ViewHelper
{
    ...
    public function availableExtensions($type, $func)
    {
        ...
        $hasAdminAccess = $permissionHelper->hasPermission('MUEternizerModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
    ...
    protected function processPdf(Zikula_View $view, Request $request, $template)
    {
        ...
        $controllerHelper = $this->container->get('mueternizermodule.controller_helper');
