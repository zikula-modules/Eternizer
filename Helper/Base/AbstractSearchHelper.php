...
abstract class AbstractSearchHelper extends AbstractSearchable
{
    ...
    public function getOptions($active, $modVars = null)
    {
        ...
        $searchTypes = array('entry');
        foreach ($searchTypes as $searchType) {
            $templateParameters['active_' . $searchType] = (!isset($args['mUEternizerModuleSearchTypes']) || in_array($searchType, $args['mUEternizerModuleSearchTypes']));
        }
    
        return $this->getContainer()->get('twig')->render('@MUEternizerModule/Search/options.html.twig', $templateParameters);
    }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        if (!is_array($searchTypes) || !count($searchTypes)) {
            if ($request->isMethod('GET')) {
                $searchTypes = $request->query->get('mUEternizerModuleSearchTypes', []);
            } elseif ($request->isMethod('POST')) {
                $searchTypes = $request->request->get('mUEternizerModuleSearchTypes', []);
            }
        }
        ...
        foreach ($searchTypes as $objectType) {
            ...
            $repository = $serviceManager->get('mu_eternizer_module.' . $objectType . '_factory')->getRepository();
