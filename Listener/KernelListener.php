...
use MU\EternizerModule\Listener\Base\KernelListener as BaseKernelListener;
...
class KernelListener extends BaseKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from eternizer app';
        // $event->getRequest()->attributes->set('MUEternizerModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('MUEternizerModule_test');
        // now $testMessage should be: 'Hello from eternizer app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'eternizer App Error says: %s with code: %s',
