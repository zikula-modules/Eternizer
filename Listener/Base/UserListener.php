...
class UserListener implements EventSubscriberInterface
{
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $repo = $entityManager->getRepository('MU\EternizerModule\Entity\EntryEntity');
        // set creator to admin (2) for all entries created by this user
        $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all entries updated by this user
        $repo->updateLastEditor($uid, 2);
        
        $logger = $serviceManager->get('logger');
        $logger->notice('{app}: User {user} has been deleted, so we deleted corresponding {entities}, too.', array('app' => 'MUEternizerModule', 'user' => UserUtil::getVar('uname'), 'entities' => 'entries'));
    }
}
