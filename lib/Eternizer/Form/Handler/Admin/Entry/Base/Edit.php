 ...
 */
class Eternizer_Form_Handler_Admin_Entry_Base_Edit extends Eternizer_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeLowerMultiple = 'entries';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'entry', 'id' => $this->idValues['id']));
        }
        return $url;
    }
