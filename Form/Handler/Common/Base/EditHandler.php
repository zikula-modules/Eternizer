...
use MU\EternizerModule\Form\Plugin\AbstractObjectSelector;
...
class EditHandler extends Zikula_Form_AbstractHandler
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $entityClass = 'MUEternizerModule:' . ucfirst($this->objectType) . 'Entity';
        $this->idFields = ModUtil::apiFunc($this->name, 'selection', 'getIdFields', array('ot' => $this->objectType));
    
        // retrieve identifier of the object we wish to view
        $controllerHelper = $this->view->getServiceManager()->get('mueternizermodule.controller_helper');
        ...
        if ($actions === false || !is_array($actions)) {
            ...
            $logger->error('{app}: User {user} tried to edit the {entity} with id {id}, but failed to determine available workflow actions.', array('app' => 'MUEternizerModule', 'user' => UserUtil::getVar('uname'), 'entity' => $this->objectType, 'id' => $entity->createCompositeIdentifier()));
    ...
    protected function initEntityForCreation()
    {
        ...
        if ($this->hasTemplateId === true) {
            ...
            $entityClass = 'MU\\EternizerModule\\Entity\\' . ucfirst($this->objectType) . 'Entity';
            $createMethod = 'create' . ucfirst($this->objectType);
            $entity = $this->view->getContainer()->get('mueternizermodule.' . $this->objectType . '_factory')->$createMethod();
        }
    ...
    {
        $repository = $this->view->getServiceManager()->get('mueternizermodule.' . $this->objectType . '_factory')->getRepository();
