...
abstract class AbstractEditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if (false === $actions || !is_array($actions)) {
            ...
            $logArgs = ['app' => 'MUEternizerModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => $this->objectType, 'id' => $entity->createCompositeIdentifier()];
    ...
    public function handleCommand($args = [])
    {
        ...
        if ($entity->supportsHookSubscribers() && $action != 'cancel') {
            $hookHelper = $this->container->get('mu_eternizer_module.hook_helper');
    ...
    protected function addDefaultMessage($args, $success = false)
    {
        ...
        $logger = $this->container->get('logger');
        $logArgs = ['app' => 'MUEternizerModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => $this->objectType, 'id' => $this->entityRef->createCompositeIdentifier()];
        if (true === $success) {
