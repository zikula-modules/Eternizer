...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{getbaseurl}modules/Eternizer/javascript/Eternizer_editFunctions.js"></script>
    </head>
    <body>
    <script type="text/javascript" charset="utf-8">
        ...
        eternizerCloseWindowFromInside('{{$idPrefix}}', {{if $commandName eq 'create'}}{{$itemId}}{{else}}0{{/if}});
        });
        /* ]]> */
    </script>
    </body>
