...
<table class="z-datatable">
    ...
    <tr>
        <th id="hip" scope="col" align="left" valign="middle">
            {sortlink __linktext='Ip' sort='ip' currentsort=$sort sortdir=$sdir modname='Eternizer' type='admin' func='view' ot='entry'}
        </th>
        <th id="htext" scope="col" align="left" valign="middle">
            {sortlink __linktext='Text' sort='text' currentsort=$sort sortdir=$sdir modname='Eternizer' type='admin' func='view' ot='entry'}
        </th>
        <th id="hnotes" scope="col" align="left" valign="middle">
            {sortlink __linktext='Notes' sort='notes' currentsort=$sort sortdir=$sdir modname='Eternizer' type='admin' func='view' ot='entry'}
        </th>
    ...
    <tr class="{cycle values='z-odd, z-even'}">
        ...
        <td headers="hintactions" align="left" valign="top" style="white-space: nowrap">
            <a href="{modurl modname='Eternizer' type='admin' func='display' ot='entry' id=$entry.id}" title="{$entry.ip|replace:"\"":""}">
                {icon type='display' size='extrasmall' __alt='Details'}
            </a>
    {checkpermissionblock component='Eternizer::' instance='.*' level='ACCESS_EDIT'}
            <a href="{modurl modname='Eternizer' type='admin' func='edit' ot='entry' id=$entry.id}" title="{gt text='Edit'}">
                {icon type='edit' size='extrasmall' __alt='Edit'}
            </a>
            <a href="{modurl modname='Eternizer' type='admin' func='edit' ot='entry' astemplate=$entry.id}" title="{gt text='Reuse for new item'}">
