...
<div class="z-admin-content-pagetitle">
    ...
    {form cssClass='z-form'}
        ...
        <div class="z-warningmsg z-formnote">{gt text="Warning: Don' forget to make a backup of your database before using this import form!"}</div>
                <div class="z-informationmsg z-formnote">{gt text="Notice: With this form you are able to move your old entries into the new table. You can get the attributes 'name', 'email, 'homepage' and 'location' from the objectdata_attributes table for the entries if saved there. 
                You can delete the old table. And you can delete the entries for Eternizer in the table objectdata_attributes."}</div>               
