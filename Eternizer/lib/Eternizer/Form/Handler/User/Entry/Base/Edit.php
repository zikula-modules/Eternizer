 ...
 */
class Eternizer_Form_Handler_User_Entry_Base_Edit extends Eternizer_Form_Handler_User_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'entry', 'id' => $this->idValues['id']));
        }
        return $url;
    }
