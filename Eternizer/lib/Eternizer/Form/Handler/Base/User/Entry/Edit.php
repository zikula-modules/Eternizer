 ...
 */
class Eternizer_Form_Handler_Base_User_Entry_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'edit') {
            ...
            $returnUrl = ModUtil::url('Eternizer', 'user', 'display', array('ot' => 'entry', 'id' => $this->idValues['id']));
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        $url = ModUtil::url('Eternizer', 'user', 'view', $viewArgs);

        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated entry
            $url = ModUtil::url('Eternizer', 'user', 'display', array('ot' => 'entry', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        if (in_array($args['commandName'], array('create', 'update'))) {
            ...
            $url = new Zikula_ModUrl('Eternizer', 'user', 'display', ZLanguage::getLanguageCode(), array('ot' => $this->objectType, 'id' => $this->idValues['id']));
    ...
    protected function getRedirectUrl($args, $obj, $repeatCreateAction = false)
    {
        if ($this->inlineUsage == true) {
            ...
            return ModUtil::url('Eternizer', 'user', 'handleInlineRedirect',
