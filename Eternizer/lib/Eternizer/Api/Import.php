 ...
 */
class Eternizer_Api_Import extends Zikula_AbstractApi
{
    /**
     ...
     */
    public function getInstalledBooks($args)
    {
        ...
        $books =& ModUtil::apiFunc('Eternizer', 'import', 'getObject');
    ...
    public function import($args)
    {
        ...
        $obj =& ModUtil::apiFunc('Eternizer', 'import', 'getObject', array('name' => $args['plugin']));
