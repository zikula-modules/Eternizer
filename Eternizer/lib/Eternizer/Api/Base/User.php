 ...
 */
class Eternizer_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new Eternizer_RouterFacade();
        ...
        $allowedObjectTypes = Eternizer_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : Eternizer_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        $modInfo = ModUtil::getInfoFromName('Eternizer');
    ...
    public function decodeurl($args)
    {
        ...
        $funcs = array('main', 'view', 'edit', 'display');
