 ...
 */
class Eternizer_Api_Base_Selection extends Zikula_AbstractApi
{
    /**
    ...
    protected function determineObjectType($args, $methodName = '')
    {
        ...
        if (!in_array($objectType, Eternizer_Util_Controller::getObjectTypes('api', $utilArgs))) {
            $objectType = Eternizer_Util_Controller::getDefaultObjectType('api', $utilArgs);
        }
        return $objectType;
    }
    ...
    protected function getRepository($objectType = '')
    {
        ...
        return $this->entityManager->getRepository('Eternizer_Entity_' . ucfirst($objectType));
    }
