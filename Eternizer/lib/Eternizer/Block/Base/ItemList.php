 ...
 */
class Eternizer_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('Eternizer:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('Eternizer')) {
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('Eternizer:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (!isset($vars['objectType']) || !in_array($vars['objectType'], Eternizer_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = Eternizer_Util_Controller::getDefaultObjectType('block');
        }
        ...
        if (empty($blockinfo['title'])) {
            $blockinfo['title'] = $this->__('Eternizer items');
        }
    ...
    public function update($blockinfo)
    {
        ...
        if (!in_array($vars['objectType'], Eternizer_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = Eternizer_Util_Controller::getDefaultObjectType('block');
        }
