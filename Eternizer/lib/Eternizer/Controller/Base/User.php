 ...
 */
class Eternizer_Controller_Base_User extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    {
        // DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('Eternizer::', '::', ACCESS_READ));
        // DEBUG: permission check aspect ends

        // parameter specifying which type of objects we are treating
        $objectType = $this->request->getGet()->filter('ot', 'entry', FILTER_SANITIZE_STRING);
        ...
        if ($tpl == 'tree') {
            ...
            return Eternizer_Util_View::processTemplate($this->view, 'user', $objectType, 'view', $args);
        }
        ...
        $currentUrlObject = new Zikula_ModUrl('Eternizer', 'user', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    {
        // DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('Eternizer::', '::', ACCESS_EDIT));
        // DEBUG: permission check aspect ends
        ...
        $handlerClass = 'Eternizer_Form_Handler_User_' . ucfirst($objectType) . '_Edit';
    ...
    public function display($args)
    {
        ...
        $currentUrlObject = new Zikula_ModUrl('Eternizer', 'user', 'display', ZLanguage::getLanguageCode(), $currentUrlArgs);
        ...
        // fetch and return the appropriate template
        return Eternizer_Util_View::processTemplate($this->view, 'user', $objectType, 'display', $args);
    }
