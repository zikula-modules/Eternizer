...
abstract class AbstractItem extends \Content_AbstractContentType
{
    ...
    {
        return ServiceUtil::get('translator.default')->__('MUEternizerModule detail view');
    }
    ...
    {
        return ServiceUtil::get('translator.default')->__('Display or link a single MUEternizerModule object.');
    }
