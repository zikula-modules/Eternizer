...
abstract class AbstractNotificationHelper
{
    ...
    protected function collectRecipients()
    {
        ...
        if ($this->recipientType == 'moderator' || $this->recipientType == 'superModerator') {
            ...
            $moderatorGroupId = $this->variableApi->get('MUEternizerModule', 'moderationGroupFor' . $modVarSuffix, 2);
            if ($this->recipientType == 'superModerator') {
                $moderatorGroupId = $this->variableApi->get('MUEternizerModule', 'superModerationGroupFor' . $modVarSuffix, 2);
            }
