...
use MU\EternizerModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        // create query
        $orderBy = $this->get('mu_eternizer_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        $templateParameters = $this->get('mu_eternizer_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
