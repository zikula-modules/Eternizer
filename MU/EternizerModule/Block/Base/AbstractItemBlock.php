...
use MU\EternizerModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUEternizerModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        $controllerReference = new ControllerReference('MUEternizerModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUEternizerModule/Block/item_modify.html.twig';
    }
