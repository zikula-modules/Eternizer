...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUEternizerModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single MUEternizerModule object.');
    }
