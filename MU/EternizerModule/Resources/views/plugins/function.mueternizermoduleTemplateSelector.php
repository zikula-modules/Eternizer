...
/**
 * The mueternizermoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_mueternizermoduleTemplateSelector($params, $view)
{
