...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'MUEternizerModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $container->get('mu_eternizer_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'MUEternizerModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('mu_eternizer_module.workflow_helper');
