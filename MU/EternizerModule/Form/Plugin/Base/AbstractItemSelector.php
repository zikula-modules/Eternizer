...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUEternizerModule:js/MUEternizerModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUEternizerModule:js/MUEternizerModule.ItemSelector.js'));
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUEternizerModule_objecttype', 'entry');
