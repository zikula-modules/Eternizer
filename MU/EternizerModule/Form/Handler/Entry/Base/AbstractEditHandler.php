...
use MU\EternizerModule\Form\Type\EntryType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                ...
                $logArgs = ['app' => 'MUEternizerModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType];
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(EntryType::class, $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated entry
        $codes[] = 'userDisplay';
        // admin detail page of treated entry
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        $routePrefix = 'mueternizermodule_' . $this->objectTypeLower . '_' . $routeArea;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUEternizerModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'entry', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('mueternizermodule' . $this->objectTypeCapital . 'Referer')) {
            $this->request->getSession()->remove('mueternizermodule' . $this->objectTypeCapital . 'Referer');
        }
