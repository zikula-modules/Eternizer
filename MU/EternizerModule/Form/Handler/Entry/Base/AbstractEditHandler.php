...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('MU\EternizerModule\Form\Type\EntryType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUEternizerModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'entry', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('mueternizermodule' . $this->objectTypeCapital . 'Referer')) {
            $this->request->getSession()->del('mueternizermodule' . $this->objectTypeCapital . 'Referer');
        }
