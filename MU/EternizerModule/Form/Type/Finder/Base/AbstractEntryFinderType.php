...
namespace MU\EternizerModule\Form\Type\Finder\Base;
...
/**
 * Entry finder form type base class.
 */
abstract class AbstractEntryFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * EntryFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the entry') => 1,
                $this->__('Absolute url to the entry') => 2,
                $this->__('ID of entry') => 3
            ],
    ...
    {
        return 'mueternizermodule_entryfinder';
    }
