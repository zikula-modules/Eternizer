...
class EternizerEvents
{
    ...
    /**
     * The mueternizermodule.entry_pre_save event is thrown before a new entry
     * is created or an existing entry is updated in the system.
     *
     * The event listener receives an
     * MU\EternizerModule\Event\FilterEntryEvent instance.
     *
     ...
     * @var string
     */
    const ENTRY_PRE_SAVE = 'mueternizermodule.entry_pre_save';
    
    /**
     * The mueternizermodule.entry_post_save event is thrown after a new entry
     * has been created or an existing entry has been updated in the system.
     *
     * The event listener receives an
     * MU\EternizerModule\Event\FilterEntryEvent instance.
     *
     ...
     * @var string
     */
    const ENTRY_POST_SAVE = 'mueternizermodule.entry_post_save';
