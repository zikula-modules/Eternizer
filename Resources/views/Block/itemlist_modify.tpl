...
<div class="form-group">
    <label for="mUEternizerModuleObjectType" class="col-sm-3 control-label">{gt text='Object type'}:</label>
    <div class="col-sm-9">
        <select id="mUEternizerModuleObjectType" name="objecttype" size="1" class="form-control">
...
{if $catIds ne null && is_array($catIds)}
    ...
    {foreach key='propertyName' item='propertyId' from=$catIds}
        <div class="form-group">
            ...
            <div class="col-sm-9">
                {selector_category name="`$categorySelectorName``$propertyName`" field='id' selectedValue=$catIds.$propertyName categoryRegistryModule='MUEternizerModule' categoryRegistryTable=$objectType categoryRegistryProperty=$propertyName defaultText=$lblDefault editLink=false multipleSize=$categorySelectorSize cssClass='form-control'}
...
<div class="form-group">
    <label for="mUEternizerModuleSorting" class="col-sm-3 control-label">{gt text='Sorting'}:</label>
    <div class="col-sm-9">
        <select id="mUEternizerModuleSorting" name="sorting" class="form-control">
...
<div class="form-group">
    <label for="mUEternizerModuleAmount" class="col-sm-3 control-label">{gt text='Amount'}:</label>
    <div class="col-sm-9">
        <input type="text" id="mUEternizerModuleAmount" name="amount" maxlength="2" size="10" value="{$amount|default:"5"}" class="form-control" />
    </div>
</div>

<div class="form-group">
    <label for="mUEternizerModuleTemplate" class="col-sm-3 control-label">{gt text='Template'}:</label>
    <div class="col-sm-9">
        <select id="mUEternizerModuleTemplate" name="template" class="form-control">
...
<div id="customTemplateArea" class="form-group hidden" data-switch="mUEternizerModuleTemplate" data-switch-value="custom">
    <label for="mUEternizerModuleCustomTemplate" class="col-sm-3 control-label">{gt text='Custom template'}:</label>
    <div class="col-sm-9">
        <input type="text" id="mUEternizerModuleCustomTemplate" name="customtemplate" size="40" maxlength="80" value="{$customTemplate|default:''}" class="form-control" />
        <span class="help-block">{gt text='Example'}: <em>itemlist_[objectType]_display.tpl</em></span>
    </div>
</div>

<div class="form-group">
    <label for="mUEternizerModuleFilter" class="col-sm-3 control-label">{gt text='Filter (expert option)'}:</label>
    <div class="col-sm-9">
        <input type="text" id="mUEternizerModuleFilter" name="filter" size="40" value="{$filterValue|default:''}" class="form-control" />
