...
{form cssClass='form-horizontal' role='form'}
    ...
    {if $mode ne 'create'}
        ...
        {notifydisplayhooks eventname='mueternizermodule.ui_hooks.entries.form_edit' id=$hookId assign='hooks'}
    {else}
        {notifydisplayhooks eventname='mueternizermodule.ui_hooks.entries.form_edit' id=null assign='hooks'}
    {/if}
