...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{$baseurl}modules/MUEternizerModule/Resources/public/js/MUEternizerModule.EditFunctions.js"></script>
    </head>
    <body>
        ...
        /* <![CDATA[ */
            ...
            ( function($) {
                $(document).ready(function() {
                    mUEternizerCloseWindowFromInside('{{$idPrefix}}', {{if $commandName eq 'create'}}{{$itemId}}{{else}}0{{/if}});
                });
            })(jQuery);
        /* ]]> */
        </script>
